#!/bin/bash
#
# Parsing FMTRPT FY 2002-2003 other (non-Africa) sections from PDF to a tsv
...
_cleanXML () {
	...
	| sed -E '{
			s/>STENNIS SPACE CENTER, MS <//g
			s/>39529-7099</>STENNIS SPACE CENTER, MS 39529-7099</g
			s/>39522-5001</>STENNIS SPACE CENTER, MS 39522-5001</g
			s/>DEVLOPMNT<//g
			s/>NCO PROFESSIONAL </>NCO PROFESSIONAL DEVLOPMNT</g
			s/>REGULATOR<//g
			s/>LANG LAB VOlTAGE </>LANG LAB VOLTAGE REGULATOR</g
			s/>CRS<//g
			s/>INSTRUCTOR DEVELOPMENT </>INSTRUCTOR DEVELOPMENT CRS</g
			s/>CG9<//g
			s/>MTT OUTBOARD MTR MAINT </>MTT OUTBOARD MTR MAINT CG9</g
			s/>EIMET<//g
			s/>BOARDING TEAM MEMBER </>BOARDING TEAM MEMBER EIMET</g
			s/>RPR<//g
			s/>POWER GENERATION EQUIP </>POWER GENERATION EQUIP RPR</g
			s/>TNG\(MELT<//g
			s/>MANAGING ENG LANG </>MANAGING ENG LANG TNG\(MELT</g
			s/>SPC<//g
			s/>COMM-COMPUTER SYS CNTL </>COMM-COMPUTER SYS CNTL SPC</g
			s/>ANCOC<//g
			s/>TATS COMBAT ENGINEER </>TATS COMBAT ENGINEER ANCOC</g
			s/>STANDDOWN<//g
			s/>ETSS POST DEPLOY </>ETSS POST DEPLOY STANDDOWN</g
			s/>SCHOOL<//g
			s/>ACADEMIC INSTRUCTOR </>ACADEMIC INSTRUCTOR SCHOOL</g
			s/>PHYSIOLOGY\(SATP\)<//g
			s/>AEROSPACE </>AEROSPACE PHYSIOLOGY\(SATP\)</g
			s/>MAINTENANCE<//g
			s/>EIMSS HARDWARE </>EIMSS HARDWARE MAINTENANCE</g
			s/>SYSTEM<//g
			s/>COMMAND AND CONTROL </>COMMAND AND CONTROL SYSTEM</g
			s/>STF<//g
			s/>COMB AEROSPACE OPS SNR </>COMB AEROSPACE OPS SNR STF</g
			s/>SUPPORT<//g
			s/>DVOT\/OT CONTRACTOR </>DVOT\/OT CONTRACTOR SUPPORT</g
			s/>BNCOC<//g
			s/>ACFT PWRTRN RPR SUPV </>ACFT PWRTRN RPR SUPV BNCOC</g
			s/>TE<//g
			s/>PREP FOR & MANAG CONSEQ </>PREP FOR & MANAG CONSEQ TE>/g
						}' \
	...
	| sed -E '{
			...
			s/^.*left=\"1256\".*font=\"3\">(\$.*)<\/text>$/<total_cost>\1<\/total_cost>/g
			s/^.*left=\"126.\".*font=\"3\">(\$.*)<\/text>$/<total_cost>\1<\/total_cost>/g
			s/^.*left=\"126.\".*font=\"3\">([0-9].*)<\/text>$/<start_date>\1<\/start_date>/g
			s/^.*left=\"331\".*font="\3\">([0-9].*\/[0-9].*\/[0-9].*)<\/text>$/<end_date>\1<\/end_date>/g
			s/^.*left=\"1339\".*font=\"3\">(.*)<\/text>$/<end_date>\1<\/end_date>/g
			s/^.*left=\"134.\".*font=\"3\">(.*)<\/text>$/<end_date>\1<\/end_date>/g
			s/^.*left=\"833\".*font=\"7\"><b> (IV-.*)<\/b><\/text>$/<page>\1<\/page>/g
			s/^.*left=\"840\".*font=\"7\"><b> (IV-.*)<\/b><\/text>$/<page>\1<\/page>/g
			s/^.*left=\"847\".*font=\"7\"><b> (IV-.*)<\/b><\/text>$/<page>\1<\/page>/g
						}' \
	| grep -v -e "<text.*text>$" \
	| sed '{
