#!/bin/bash
#
# Parsing FMTRPT FY 2004-2005 Africa section from PDF to a tsv
...
_cleanXML () {
	...
	| sed -E '{
			...
			s/^.*left=\"577\".*font=\"4\"><b> (IV-.*)<\/b><\/text>$/<page>\1<\/page>/g
...
#		_xmlConvert
	...
	done < src/fmtrpt_fy_2004_2005_Africa
