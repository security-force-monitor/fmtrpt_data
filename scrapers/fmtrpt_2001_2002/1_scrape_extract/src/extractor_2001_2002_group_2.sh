#!/bin/bash
#
# Parsing  FMTRPT FY 2001-2002 from PDF to a tsv (Group 3)
#
# tl@sfm / 2017-04-02
...
# This script just deals with the 
# Loop the extractor using a file specifying page name, report year and section as variables, along wiht variables for chunks to remove
