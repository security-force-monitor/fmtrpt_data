#!/bin/bash
#
# Check generated XML for variations in element left position and font for 2003-2004 FMT Report
#
# Use:
...
# "left" and "font" options. Note that differences may still exist, but this gives you a start.
