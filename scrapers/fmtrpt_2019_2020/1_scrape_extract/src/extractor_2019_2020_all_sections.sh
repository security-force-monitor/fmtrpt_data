#!/bin/bash
#
# Parse US DOD/DOS FMTRPT FY 2019-2020 from PDF to a TSV
#
# tl@sfm / 2021-08-05
#          2024-07-02 Update to orchestrate different runs
#          2024-07-03 Update to scrape page number from PDFs
#          	
...
_cleanXML () {
	...
	| sed '{
		...
		s/<text.*left="35".*font="9">\(.*\)<\/text>/<training>%<course_title>\1<\/course_title>/g
		s/<text.*left="305".*font="3">\(.*\)<\/text>/<quantity>\1<\/quantity>/g
		s/<text.*left="305".*font="9">\(.*\)<\/text>/<quantity>\1<\/quantity>/g
		s/<text.*left="359".*font="3">\(.*\)<\/text>/<location>\1<\/location>/g
		s/<text.*left="359".*font="9">\(.*\)<\/text>/<location>\1<\/location>/g
		s/<text.*left="548".*font="3">\(.*\)<\/text>/<student_unit>\1<\/student_unit>/g
		s/<text.*left="548".*font="9">\(.*\)<\/text>/<student_unit>\1<\/student_unit>/g
		s/<text.*left="549".*font="3">\(.*\)<\/text>/<student_unit>\1<\/student_unit>/g
		s/<text.*left="549".*font="9">\(.*\)<\/text>/<student_unit>\1<\/student_unit>/g
		s/<text.*left="737".*font="3">\(.*\)<\/text>/<us_unit>\1<\/us_unit>/g
		s/<text.*left="737".*font="9">\(.*\)<\/text>/<us_unit>\1<\/us_unit>/g
		s/<text.*left="738".*font="3">\(.*\)<\/text>/<us_unit>\1<\/us_unit>/g
		s/<text.*left="738".*font="9">\(.*\)<\/text>/<us_unit>\1<\/us_unit>/g
		s/<text.*left="926".*font="3">\(.*\)<\/text>/<total_cost>\1<\/total_cost>/g
		s/<text.*left="926".*font="9">\(.*\)<\/text>/<total_cost>\1<\/total_cost>/g
		s/<text.*left="927".*font="3">\(.*\)<\/text>/<total_cost>\1<\/total_cost>/g
		s/<text.*left="927".*font="9">\(.*\)<\/text>/<total_cost>\1<\/total_cost>/g
		s/<text.*left="1007".*font="3">\(.*\)<\/text>/<start_date>\1<\/start_date>/g
		s/<text.*left="1007".*font="9">\(.*\)<\/text>/<start_date>\1<\/start_date>/g
		s/<text.*left="1008".*font="3">\(.*\)<\/text>/<start_date>\1<\/start_date>/g
		s/<text.*left="1008".*font="9">\(.*\)<\/text>/<start_date>\1<\/start_date>/g
		s/<text.*left="1088".*font="3">\(.*\)<\/text>/<end_date>\1<\/end_date>%<\/training>/g
		s/<text.*left="1088".*font="9">\(.*\)<\/text>/<end_date>\1<\/end_date>%<\/training>/g
		s/<text.*left="1089".*font="3">\(.*\)<\/text>/<end_date>\1<\/end_date>%<\/training>/g
		s/<text.*left="1089".*font="9">\(.*\)<\/text>/<end_date>\1<\/end_date>%<\/training>/g
		}' \
	| tr '%' '\n' \
	| grep -v -e "^<text"  \
	| gawk 'BEGIN { FS = "" ;page = "" }
