...
find ${i}/scrapers/fmtrpt*/output/5_xml_tsv -name "*.tsv" -exec cp {} ${i}/group_and_clean/0_get_data_files/output \;
...
find ${i}/scrapers/fmtrpt_2006_2007/output -name "*.tsv" -exec cp {} ${i}/group_and_clean/0_get_data_files/output \;
